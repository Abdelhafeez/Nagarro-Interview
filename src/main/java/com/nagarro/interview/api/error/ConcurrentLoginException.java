...
/**
 * ConcurrentLoginException.java This is a model class represents
 * ConcurrentLoginException This Exception must only thrown when specific user
 * tries to /login while there's still an active session for the same user
 * 
