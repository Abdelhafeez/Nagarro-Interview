...
/**
 * UserCanNotFilterParametersException.java This is a model class represents
 * UserCanNotFilterParametersException This Exception must only thrown when
 * specific user tries to add filter data
 * 
